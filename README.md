About azure-storage-blobs-cpp-feedstock
=======================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/azure-storage-blobs-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-storage-blobs-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add azure-storage-blobs-cpp
# for installing globally
pixi global install azure-storage-blobs-cpp
```
...
It is possible to list all of the versions of `azure-storage-blobs-cpp` available on your platform:
...
```
pixi search azure-storage-blobs-cpp --channel conda-forge
```
